...
Shader "PIDI Shaders Collection/Planar Reflections 4/Water Shaders/Advanced" {
	Properties {
	...
	FallBack "PIDI Shaders Collection/Planar Reflections 4/Water Shaders/Mobile Water"
}
