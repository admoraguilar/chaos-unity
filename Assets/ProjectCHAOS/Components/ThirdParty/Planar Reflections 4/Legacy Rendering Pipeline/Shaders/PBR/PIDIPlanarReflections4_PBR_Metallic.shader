...
Shader "PIDI Shaders Collection/Planar Reflections 4/PBR/Metallic"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            dMask = tex2D(_DetailMask, IN.uv_DetailMask).a;
            ...
            m.a = lerp( _Glossiness * m.a, (1 - _Glossiness) * (1 - m.a ), _IsRoughness );

            half3 mainNormal = UnpackScaleNormal( tex2D(_BumpMap, mainUV), _BumpScale );

            half4 fog = tex2D(_ReflectionFog, mainUV);
