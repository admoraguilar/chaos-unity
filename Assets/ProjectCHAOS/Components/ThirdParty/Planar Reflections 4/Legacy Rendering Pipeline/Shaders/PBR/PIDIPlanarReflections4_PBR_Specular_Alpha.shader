...
Shader "PIDI Shaders Collection/Planar Reflections 4/PBR/Specular (Alpha)"
{
    Properties
    {
        ...
        [Header(Specular and Gloss)]
		[Space(10)]
        [Toggle]_IsRoughness("Gloss as Roughness", Float) = 0
        _Glossiness ("Smoothness", Range(0,1)) = 0.5
        _SpecColor ("Specular Color", Color ) = (0.12,0.12,0.12) 
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandardSpecular o)
        {
            ...
            fixed4 m = tex2D(_SpecGlossMap, mainUV);
