    ...
    */
    ...
    public class PlanarReflectionCaster : MonoBehaviour {
        ...
        private void OnEnable() {
            ...
            if ( castReflection.Length != castFog.Length )
                castFog = new bool[castReflection.Length];
            ...
            Camera.onPreRender -= AssignReflections;
            Camera.onPreRender += AssignReflections;
        ...
        void AssignReflections( Camera cam ) {
            ...
            for ( int i = 0; i < castReflection.Length; i++ ) {
                ...
                if ( castReflection[i] || castDepth[i] ) {
                    ...
                    if ( castDepth[i] && castFromRenderer.Settings.renderDepth ) {
                        ...
                        mBlock.SetTexture( _reflectionDepth, (Texture)Texture2D.blackTexture );
                    }
