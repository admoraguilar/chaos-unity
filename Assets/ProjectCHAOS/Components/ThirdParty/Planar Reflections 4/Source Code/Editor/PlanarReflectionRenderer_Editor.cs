    ...
    public class PlanarReflectionRenderer_Editor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if ( BeginCenteredGroup("Main Settings", ref _folds[0] ) ) {
                ...
                Toggle( new GUIContent( "Reflection Fog", "Whether this reflection will render its own fog texture or not" ), serializedObject, "_settings.renderFog", 1 );
                ...
                serializedObject.FindProperty( "_settings.useAntialiasing" ).boolValue = false;
            ...
            GUILayout.Label( "Copyright© 2017-2022,   Jorge Pinal N.", lStyle );
        ...
        private void AssetLogoAndVersion() {
            ...
            GUILayout.Label( "v4.0.8", pidiSkin2.customStyles[2] );
            GUILayout.Space( 6 );
