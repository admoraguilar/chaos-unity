...
{
    public class GearsFX_Welcome : EditorWindow
    {
        //sUBSCRIBE
        ...
        {
            EditorWindow editorWindow = GetWindow(typeof(GearsFX_Welcome), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Subscribe to OrangedKeys Newsletter to be updated about our Next Assets Tutorials/Releases/Updates. \n", RegularTextStyle);
            EditorGUILayout.Space();
        ...
        [SerializeField]
        private string _apiKey = "8f90cca09f28129f593b904acdfc29f8-us4";
        [SerializeField]
